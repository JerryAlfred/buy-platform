...
const dict = {
  ...
  'nav.home_group': { en: 'Home', zh: '首页' },
  'nav.launchpad': { en: 'Launchpad', zh: '起飞台' },
  'nav.quick_start': { en: 'Quick Start', zh: '快速开始' },
  'nav.product_dev': { en: 'Build', zh: '产品开发' },
  'nav.design_tools': { en: 'Design', zh: '设计工具' },
  'nav.advanced': { en: 'Advanced', zh: '高级功能' },
  'nav.project_workspace': { en: 'My Projects', zh: '我的项目' },
  'nav.product_wizard': { en: 'AI Product Wizard', zh: 'AI 产品向导' },
  'nav.component_search': { en: 'Component Search', zh: '元器件搜索' },
  'nav.market_intel': { en: 'Market Intelligence', zh: '市场情报' },
  'nav.compliance_guide': { en: 'Compliance Guide', zh: '合规指南' },
  'nav.prototype_bundle': { en: 'Prototype Bundle', zh: '打样套件' },
  ...
  'nav.design_templates': { en: 'Template Library', zh: '\u5f00\u6e90\u6a21\u677f\u5e93' },
  'nav.mes': { en: 'Cloud MES / ERP', zh: '云 MES / ERP' },
  'nav.mes_workbench': { en: 'MES Workbench', zh: 'MES 工作台' },
  'nav.aps_simulation': { en: 'APS Simulation', zh: 'APS 排产仿真' },
  'nav.buyer_schedule': { en: 'Buyer Schedule', zh: '买家排产看板' },
  'nav.traceability': { en: 'Order Traceability', zh: '订单溯源' },
  'nav.ai_analytics': { en: 'AI Analytics', zh: 'AI 分析中心' },
